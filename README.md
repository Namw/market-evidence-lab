...
预测研究页：<http://127.0.0.1:8001/microstructure/research/>。当前第一项研究为
主动成交失衡与未来5分钟收益：未来收益只在当前分钟至5分钟后六根K线严格连续且
全部收盘时生成；研究按时间前70%发现、后30%验证，并使用发现集十分位边界统计
两段的样本数、平均未来收益和上涨比例。迁移后可回填既有分钟数据：
