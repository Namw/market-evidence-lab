...
RESEARCH_METRICS = {
    "trade_imbalance": {
        ...
        "plain_question": "这一分钟，是追着买的人更多，还是追着卖的人更多？",
    ...
    "trade_intensity": {
        ...
        "plain_question": "这一分钟的成交额，是否明显高于过去一小时的常态？",
    ...
    "depth_drop": {
        ...
        "plain_question": "这一分钟内，买卖盘挂单是否快速变薄？",
    ...
    "spread_expansion": {
        ...
        "plain_question": "盘口价差是否比过去一小时明显变宽？",
    ...
    "top5_imbalance": {
        ...
        "plain_question": "离现价最近的五档挂单，买卖哪一侧更厚？",
    ...
    "flow_price_mismatch": {
        ...
        "plain_question": "是否出现用力买却不涨，或用力卖却不跌？",
